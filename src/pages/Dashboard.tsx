...
import {
  Users, Wallet, Package, Calendar, Bell, Store,
  TrendingUp, TrendingDown, Check, Clock, CircleDot,
} from "lucide-react";
...
const agenda = [
  { time: "09:00", name: "André Martins", barber: "Felipe", status: "Confirmado", color: "success" },
  { time: "10:00", name: "Carlos Eduardo", barber: "Rafael", status: "Em andamento", color: "primary" },
  { time: "11:00", name: "Bruno Souza", barber: "Felipe", status: "Concluído", color: "muted" },
  { time: "14:00", name: "João Pedro", barber: "Lucas", status: "Confirmado", color: "success" },
  { time: "15:00", name: "Marcelo Oliveira", barber: "Rafael", status: "Confirmado", color: "warning" },
  { time: "16:00", name: "Rafael Lima", barber: "Lucas", status: "Confirmado", color: "success" },
];
